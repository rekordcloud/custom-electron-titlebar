...
class Menubar extends lifecycle_1.Disposable {
    constructor(container, options, closeSubMenu = () => { }) {
        ...
        this._register((0, dom_1.addDisposableListener)(this.container, dom_1.EventType.KEY_DOWN, (e) => {
            ...
            const key = !!e.key ? keyCodes_1.KeyCodeUtils.fromString(e.key) : 0 /* KeyCode.Unknown */;
        ...
        this._register((0, dom_1.addDisposableListener)(window, dom_1.EventType.MOUSE_DOWN, () => {
            // This mouse event is outside the menubar so it counts as a focus out
            if (this.isFocused) {
                this.setUnfocusedState();
            }
        }));
        this._register((0, dom_1.addDisposableListener)(this.container, dom_1.EventType.FOCUS_IN, (e) => {
            let event = e;
        ...
        this._register((0, dom_1.addDisposableListener)(window, dom_1.EventType.KEY_DOWN, (e) => {
    ...
    setupMenubar() {
        ...
        topLevelMenus.forEach((menubarMenu) => {
            ...
            const buttonElement = (0, dom_1.$)('div.menubar-menu-button', { 'role': 'menuitem', 'tabindex': -1, 'aria-label': cleanMenuLabel, 'aria-haspopup': true });
            if (!menubarMenu.enabled) {
                (0, dom_1.addClass)(buttonElement, 'disabled');
            }
            const titleElement = (0, dom_1.$)('div.menubar-menu-title', { 'role': 'none', 'aria-hidden': true });
            buttonElement.appendChild(titleElement);
            (0, dom_1.append)(this.container, buttonElement);
            ...
            if (menubarMenu.enabled) {
                this._register((0, dom_1.addDisposableListener)(buttonElement, dom_1.EventType.KEY_UP, (e) => {
                    let event = new keyboardEvent_1.StandardKeyboardEvent(e);
                    let eventHandled = true;
                ...
                this._register((0, dom_1.addDisposableListener)(buttonElement, dom_1.EventType.MOUSE_DOWN, (e) => {
                    if (!this.isOpen) {
                ...
                this._register((0, dom_1.addDisposableListener)(buttonElement, dom_1.EventType.MOUSE_UP, () => {
                ...
                this._register((0, dom_1.addDisposableListener)(buttonElement, dom_1.EventType.MOUSE_ENTER, () => {
    ...
    onClick(menuIndex) {
        ...
        if (item.click) {
            item.click(item, remote.getCurrentWindow(), electronEvent);
        }
    }
    ...
    dispose() {
        ...
        this.menuItems.forEach(menuBarMenu => {
            (0, dom_1.removeNode)(menuBarMenu.titleElement);
            (0, dom_1.removeNode)(menuBarMenu.buttonElement);
        });
    }
    blur() {
        this.setUnfocusedState();
        ...
        if (this.focusedMenu) {
            ...
            if (this.focusedMenu.holder) {
                if (this.focusedMenu.holder.parentElement) {
                    (0, dom_1.removeClass)(this.focusedMenu.holder.parentElement, 'open');
                }
    ...
    showMenu(menuIndex, selectFirst = true) {
        ...
        const menuHolder = (0, dom_1.$)('ul.menubar-menu-container');
        (0, dom_1.addClass)(btnElement, 'open');
...
class ModifierKeyEmitter extends event_1.Emitter {
    constructor() {
        ...
        this._subscriptions.push((0, event_2.domEvent)(document.body, 'keydown', true)(e => {
        ...
        this._subscriptions.push((0, event_2.domEvent)(document.body, 'keyup', true)(e => {
            if (!e.altKey && this._keyStatus.altKey) {
        ...
        this._subscriptions.push((0, event_2.domEvent)(document.body, 'mousedown', true)(e => {
            this._keyStatus.lastKeyPressed = undefined;
        }));
        this._subscriptions.push((0, event_2.domEvent)(window, 'blur')(e => {
            this._keyStatus.lastKeyPressed = undefined;
            this._keyStatus.lastKeyReleased = undefined;
    ...
    dispose() {
        super.dispose();
        this._subscriptions = (0, lifecycle_1.dispose)(this._subscriptions);
    }
}
