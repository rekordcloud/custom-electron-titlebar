...
class CETMenu extends lifecycle_1.Disposable {
    constructor(container, options = {}, closeSubMenu = () => { }) {
        ...
        this._register((0, dom_1.addDisposableListener)(this.menuContainer, dom_1.EventType.KEY_DOWN, e => {
        ...
        this._register((0, dom_1.addDisposableListener)(this.menuContainer, dom_1.EventType.KEY_UP, e => {
            const event = new keyboardEvent_1.StandardKeyboardEvent(e);
        ...
        this._register((0, dom_1.addDisposableListener)(this.menuContainer, dom_1.EventType.MOUSE_OUT, e => {
            let relatedTarget = e.relatedTarget;
            if (!(0, dom_1.isAncestor)(relatedTarget, this.menuContainer)) {
                this.focusedItem = undefined;
                this.updateFocus();
                e.stopPropagation();
            }
        }));
        this._register((0, dom_1.addDisposableListener)(this.menuContainer, dom_1.EventType.MOUSE_UP, e => {
            // Absorb clicks in menu dead space https://github.com/Microsoft/vscode/issues/63575
            dom_1.EventHelper.stop(e, true);
        }));
        this._register((0, dom_1.addDisposableListener)(this.menuContainer, dom_1.EventType.MOUSE_OVER, e => {
            let target = e.target;
            if (!target || !(0, dom_1.isAncestor)(target, this.menuContainer) || target === this.menuContainer) {
                return;
            }
            while (target.parentElement !== this.menuContainer && target.parentElement !== null) {
                target = target.parentElement;
            }
            if ((0, dom_1.hasClass)(target, 'action-item')) {
    ...
    updateFocusedItem() {
        for (let i = 0; i < this.menuContainer.children.length; i++) {
            ...
            if ((0, dom_1.isAncestor)(document.activeElement, elem)) {
                this.focusedItem = i;
                break;
            }
        }
    ...
    createMenu(items) {
        items.forEach((menuItem) => {
            ...
            this._register((0, dom_1.addDisposableListener)(itemElement, dom_1.EventType.CONTEXT_MENU, (e) => {
                e.preventDefault();
                e.stopPropagation();
            }));
            let item = null;
    ...
    dispose() {
        (0, lifecycle_1.dispose)(this.items);
        this.items = [];
        (0, dom_1.removeNode)(this.getContainer());
        super.dispose();
    }
    style(style) {
...
class Submenu extends menuitem_1.CETMenuItem {
    constructor(item, submenuItems, parentData, submenuOptions) {
        ...
        this.hideScheduler = new async_1.RunOnceScheduler(() => {
            if (this.container && (!(0, dom_1.isAncestor)(document.activeElement, this.container) && this.parentData.submenu === this.mysubmenu)) {
    ...
    render(container) {
        ...
        (0, dom_1.addClass)(this.itemElement, 'submenu-item');
        this.itemElement.setAttribute('aria-haspopup', 'true');
        this.submenuIndicator = (0, dom_1.append)(this.itemElement, (0, dom_1.$)('span.submenu-indicator'));
        ...
        this._register((0, dom_1.addDisposableListener)(this.container, dom_1.EventType.KEY_DOWN, e => {
            let event = new keyboardEvent_1.StandardKeyboardEvent(e);
            if (event.equals(17 /* KeyCode.RightArrow */) || event.equals(3 /* KeyCode.Enter */)) {
                dom_1.EventHelper.stop(e, true);
            }
        }));
        this._register((0, dom_1.addDisposableListener)(this.container, dom_1.EventType.MOUSE_OVER, e => {
            if (!this.mouseOver) {
                this.mouseOver = true;
                this.showScheduler.schedule();
            }
        }));
        this._register((0, dom_1.addDisposableListener)(this.container, dom_1.EventType.MOUSE_LEAVE, e => {
            this.mouseOver = false;
        }));
        this._register((0, dom_1.addDisposableListener)(this.container, dom_1.EventType.FOCUS_OUT, e => {
            if (this.container && !(0, dom_1.isAncestor)(document.activeElement, this.container)) {
    ...
    createSubmenu(selectFirstItem = true) {
        ...
        if (!this.parentData.submenu) {
            this.submenuContainer = (0, dom_1.append)(this.container, (0, dom_1.$)('ul.submenu'));
            (0, dom_1.addClasses)(this.submenuContainer, 'menubar-menu-container');
            ...
            this.submenuDisposables.push((0, dom_1.addDisposableListener)(this.submenuContainer, dom_1.EventType.KEY_UP, e => {
                let event = new keyboardEvent_1.StandardKeyboardEvent(e);
                if (event.equals(15 /* KeyCode.LeftArrow */)) {
                    ...
                    this.submenuDisposables = (0, lifecycle_1.dispose)(this.submenuDisposables);
                    this.submenuContainer = undefined;
                }
            }));
            this.submenuDisposables.push((0, dom_1.addDisposableListener)(this.submenuContainer, dom_1.EventType.KEY_DOWN, e => {
                let event = new keyboardEvent_1.StandardKeyboardEvent(e);
                if (event.equals(15 /* KeyCode.LeftArrow */)) {
                    dom_1.EventHelper.stop(e, true);
                }
    ...
    applyStyle() {
        ...
        const isSelected = this.container && (0, dom_1.hasClass)(this.container, 'focused');
...
class Separator extends menuitem_1.CETMenuItem {
    ...
    render(container) {
        if (container) {
            this.separatorElement = (0, dom_1.append)(container, (0, dom_1.$)('a.action-label'));
            this.separatorElement.setAttribute('role', 'presentation');
            (0, dom_1.addClass)(this.separatorElement, 'separator');
        }
    }
    style(style) {
